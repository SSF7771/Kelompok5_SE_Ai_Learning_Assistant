  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // console.log("Data____getDasshboardData", data);
    ...
    <div className="min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
          {stats.map((stat, idx) => (
            <div key={idx} className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1">
        ...
        {/* RECENT ACTIVITY */}
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 hover:shadow-2xl p-8">
          ...
          (dashboardData.recentActivity.documents.length > 0 ||
            ...
            <div className="space-y-3">
              {[
                ...
                // ...(dashboardData.recentActivity.courses || []).map(
                //   (cour) => ({
                //     id: cour._id,
                //     description: cour.coursename,
                //     timestamp: cour.lastAccessed,
                //     link: `/semesters/${semester.semesterNumber}/${semester?.courses.cour._id}`,
                //     type: "course",
                //   }),
                // ),
                ...
                .map((activity, idx) => (
                  ...
                  >
                        ...
                        <div
                          className={`w-2 h-2 rounded-full ${
                            activity.type === "document"
                              ...
                              : "bg-linear-to-r from-blue-400 to-teal-500"
                          }`}
                        />
                    ...
                    {activity.link && (
                      <a href={activity.link} className="ml-4 px-4 py-2 text-xs font-semibold text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-all duration-200 whitespace-nowrap">
                        View
                      </a>
                    )}
                  </div>
