...
import docuentService from "../../services/DocumentService.js";
...
const DocumentListPage = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const data = await docuentService.getDocuments();
  ...
  const handleUpload = async (e) => {
    ...
    if (!uploadFile || !uploadTitle) {
      toast.error("Please provide a title and a wanted file!");
      return;
    }
    ...
    try {
      await docuentService.uploadDocument(formData);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      await docuentService.deleteDocument(selectedDoc._id);
      ...
      return (
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-xl bg-linear-to-br from-slate-100 to-slate-200 shadow-lg shadow-slate-200/50 mb-6">
              <FileText
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 active:scale-[0.98]"
            >
              ...
              <div className="space-y-2">
                ...
                <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-blue-400 hover:bg-blue-50/30 transition-all duration-200">
                  ...
                  <div className="flex flex-col items-center justify-center py-10 px-6">
                    <div className="w-14 h-14 rounded-xl bg-linear-to-r from-blue-100 to-teal-100 flex items-center justify-center mb-4">
                      <Upload
